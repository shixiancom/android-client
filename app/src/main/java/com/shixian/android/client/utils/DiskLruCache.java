...
public class DiskLruCache {
     ...
     * {@link com.shixian.android.client.utils.DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra
     ...
     * be called directly, call {@link com.shixian.android.client.utils.DiskLruCache#clearCache(android.content.Context, String)}
     * or {@link com.shixian.android.client.utils.DiskLruCache#clearCache()} instead.
     * 
     * @param cacheDir
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        final String cachePath = Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED || !CacheUtils.isExternalStorageRemovable() ? CacheUtils
     ...
     * {@link com.shixian.android.client.utils.DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)} first to set
